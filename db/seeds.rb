...
agent = User.where(email: 'agent@gmail.com').first_or_create({ email: 'agent@gmail.com', password: 'testtest', password_confirmation: 'testtest' })
agent.agent = true
agent.save!

customer = User.where(email: 'customer@gmail.com').first_or_create({ email: 'customer@gmail.com', password: 'testtest', password_confirmation: 'testtest' })
customer.save!
